...
import { useAdminchangepasswordDataMutation, useAdminloginDataMutation } from '../../../redux/services/adminAPI'


const schema = yup.object().shape({
  oldPassword: yup.string().required('Password is required!').min(3, 'Password must be at least 6 characters'),
