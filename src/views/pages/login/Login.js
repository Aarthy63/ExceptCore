...
const Login = () => {
  ...
  return (
    <div className=" min-vh-100 d-flex flex-row align-items-center" style={{backgroundColor:'black'}}>
      <CContainer style={{backgroundColor:'black'}}>
        <CRow className="justify-content-center" style={{backgroundColor:'black'}}>
          <CCol md={8} >
            <CCardGroup style={{backgroundColor:'black'}}>
              <CCard className="p-4"style={{backgroundColor:'black'}}>
                <CCardBody style={{backgroundColor:'black', color:'wheat'}}>
              ...
              <CCard className="text-white py-5 mt-0" style={{ width: '44%', backgroundColor: 'black' }}>
  <CCardBody className="text-center text-black">
    <label className="fs-5 text-white">Unlock your Pattern Lock</label>
    <div className="d-flex justify-content-center"> {/* Aligns PatternLock to the center */}
      <PatternLock
        width={230}
        pointSize={16}
        size={3}
        ...
        onFinish={() => {
          // Handle pattern finish if needed
        }}
        className="ms-3 mt-3 text-center"
